...
export default class About extends Component {
  render() {
    return (
      ...
      <Text style={[styles.textColor, customStyles.body]}>Features</Text>
      <Text style={[styles.textColor, customStyles.body]}>Offline Capabilities</Text>
      ...
      <Text style={[styles.textColor, customStyles.body]}>Activities</Text>
      ...
      <Text style={[styles.textColor, customStyles.body]}>Explore</Text>
      ...
      <Text style={[styles.textColor, customStyles.body]}>Exams</Text>
      ...
      <Text style={[styles.textColor, customStyles.body]}>Theme</Text>
      ...
      <Text style={[styles.textColor, customStyles.body]}>Bookmarks</Text>
