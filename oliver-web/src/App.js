                       ...
                       <div className="row">
                           <div className="col-md-6 wow fadeInLeftBig">
                               ...
                               <div className="video-button">
                                   ...
                                   <a className="btn btn-primary btn-video" href="#FEATURES" role="button">Features</a>
                               </div>
                           </div>
                              ...
                              <div className="col-md-12 wow bounceInDown">
                                  <div id="carousel-example-caption-testimonial" className="carousel slide" data-ride="carousel">
                                      ...
                                      <ol className="carousel-indicators">
                                          <li data-target="#carousel-example-caption-testimonial" data-slide-to="0" className="active"></li>
                  ...
                  <div className="container">
                      <div className="row">
                          <div className="col-md-8 col-md-offset-2">
                              <div className="download_screen text-center wow fadeInUp" data-wow-duration="1s">
                              ...
                              <div className="col-md-12 wow bounceInLeft">
                                  <div className="social_icons">
                                      <ul>
                                          ...
                                          <li><a href=""><i className="fa fa-behance"></i></a>
                                          </li>
                                          <li><a href=""><i className="fa fa-youtube-play"></i></a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
